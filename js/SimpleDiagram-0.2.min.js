...
var c=r.split("%%"),p=document.createElementNS(d3.ns.prefix.svg,"text"),u=d3.select(p).attr({x:s.x+t.__settings.cellSize/2,y:s.y+t.__settings.cellSize/2-(s.y+t.__settings.cellSize),"text-anchor":a.align||"middle","class":"label"})
